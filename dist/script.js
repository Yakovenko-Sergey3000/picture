...
/* harmony import */ var _modules_maskNumber__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/maskNumber */ "./src/js/modules/maskNumber.js");
/* harmony import */ var _modules_validName__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/validName */ "./src/js/modules/validName.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["default"])('.main-slider-item', 'vertically');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_0__["default"])(state);
  Object(_modules_maskNumber__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
  Object(_modules_validName__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"');
...
var calc = function calc(size, material, options, promocode, result, state) {
  ...
  var calcSum = function calcSum() {
    ...
    state['sale'] = !promocodeBlock ? '0руб' : "".concat(sele, "\u0440\u0443\u0431");
    state['result'] = "".concat(sum, "\u0440\u0443\u0431"); // console.log(state);
  };
...
var filter = function filter() {
  ...
  var addEvent = function addEvent(btns, mark) {
...
/* harmony import */ var _service_getResurce__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../service/getResurce */ "./src/js/service/getResurce.js");
...
var forms = function forms(state) {
  ...
  var createBlockMessage = function createBlockMessage(url, text, form) {
  ...
  forms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      console.log(api);
      Object(_service_getResurce__WEBPACK_IMPORTED_MODULE_12__["postData"])(api, formData).then(function (res) {
        console.log(res);
...
var maskNumber = function maskNumber(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (maskNumber);
...
var modals = function modals() {
  ...
  var bindModal = function bindModal(openTrigger, selectorModal, closeTrigger) {
    ...
    var openBtn = document.querySelectorAll(openTrigger),
    ...
    openBtn.forEach(function (btn) {
      btn.addEventListener('click', function (e) {
        ...
        var scrollPresent = parseInt(getComputedStyle(presents).right);
        presents.style.right = "".concat(scrollPresent + scroll, "px");
      });
    });
  ...
  var showTimeByModal = function showTimeByModal(selector, time) {
    var display;
    setTimeout(function () {
  ...
  openByScroll('.fixed-gift'); // showTimeByModal('.popup-consultation', 3000);
};
...
/* harmony import */ var _service_getResurce__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service/getResurce */ "./src/js/service/getResurce.js");





var showMoreStyles = function showMoreStyles(triger, wrapper) {
  var colStyle = document.querySelector(wrapper),
      btn = document.querySelector(triger);

  var showStyles = function showStyles(response, parent) {
  ...
  var showError = function showError(response, parent) {
    var item = document.createElement('div');
  ...
  btn.addEventListener('click', function () {
    Object(_service_getResurce__WEBPACK_IMPORTED_MODULE_3__["getStyles"])('http://localhost:3000/styles').then(function (res) {
      return showStyles(res, colStyle);
    }).catch(function (error) {
      return showError(error.message, colStyle.parentNode);
    });
    this.remove();
  });
};
...
var slider = function slider(slides, dir, prev, next) {
  var indexSlider = 1,
      stopSlider = false;
  var item = document.querySelectorAll(slides);
  ...
  var autoSlider = function autoSlider() {
    stopSlider = setInterval(function () {
      if (dir === 'vertically') {
        plusSlider(1);
  ...
  autoSlider();
  item[0].parentNode.addEventListener('mouseenter', function () {
    clearInterval(stopSlider);
  });
  item[0].parentNode.addEventListener('mouseleave', function () {
    autoSlider();
  });
};
...
var validName = function validName(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (validName);

/***/ }),

/***/ "./src/js/service/getResurce.js":
/*!**************************************!*\
  !*** ./src/js/service/getResurce.js ***!
  \**************************************/
/*! exports provided: postData, getStyles */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var getStyles = function getStyles(url) {
  var res;
  return regeneratorRuntime.async(function getStyles$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Can't get url: ".concat(url, ", status: ").concat(res.status));
